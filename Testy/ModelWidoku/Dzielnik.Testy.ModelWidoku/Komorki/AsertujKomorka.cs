...
namespace Dzielnik.Testy.ModelWidoku.Komorki
{
    internal class AsertujKomorka
    {
        ...
        {Asertuj(kolumnaZadana, rzadZadany, tekstZadany, komorka);
        ...
        public static void AsertujKolorTla(Brush kolorTlaZadany, Brush kolorTlaZwrocony)
        {
            //Asercja
            Assert.Equal(kolorTlaZadany, kolorTlaZwrocony);
        }
    }
}